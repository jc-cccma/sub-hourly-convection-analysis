...
filename1b = '/home/rtm/spCAM5/GCM_OMEGA/OMEGA.nc'
...
;===================================================================================
rpsopen, '2D_pdf_reversible_dCAPElse_vs_OMEGA_spCAM5_h2_pcp_e-4_small_binsize', /encap, xs=14, ys=10, /inches, /color
...
ay2=0.90
  ...
  COLORBAR,  NColors=levels, C_Colors=(Indgen(levels)+3), Bottom=3, Divisions=10, YTITLE = 'Conv. precipitation (mmh!E-1!N)', $
