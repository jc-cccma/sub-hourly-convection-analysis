...
filename5 = '/home/rtm/spCAM5/RH.nc'
...
CAPE_EVENT = FLTARR(5000,count1/85)
CAPE_EVENT[*,*] = 1.E30
CIN_EVENT = FLTARR(5000,count1/85)
CIN_EVENT[*,*] = 1.E30

dCAPEdt_EVENT = FLTARR(5000,count1/85)
dCAPEdt_EVENT[*,*] = 1.E30
dCAPElse_EVENT = FLTARR(5000,count1/85)
dCAPElse_EVENT[*,*] = 1.E30

CONV_PCP_EVENT = FLTARR(5000,count1/85)
CONV_PCP_EVENT[*,*] = 1.E30

RH_EVENT = FLTARR(5000,nlev,count1/85)
RH_EVENT[*,*,*] = 1.E30
...
; DEF 2
        IF (CONV_PCP1[LON1, LAT1, TIME1+1] GT 0.01) AND $
...
;DEF 2
                        IF (CONV_PCP1[LON1, LAT1, TIME2] EQ 0.) THEN GOTO, OUT
                ENDFOR
        ENDIF
        OUT:
;=====================
...
FOR TIME4 = 0,17 DO BEGIN
        ...
        INDEX1000 = WHERE((CAPE_EVENT[*,TIME4] NE 0.) AND (CAPE_EVENT[*,TIME4] LT 10000.) AND (dCAPElse_EVENT[*,TIME4] GT -50000.) AND (dCAPElse_EVENT[*,TIME4] LT 50000.) AND (dCAPElse_EVENT[*,TIME4] NE 0.) AND (dCAPElsp_EVENT[*,TIME4] GT -50000.) AND (dCAPElsp_EVENT[*,TIME4] LT 50000.) AND (dCAPElsp_EVENT[*,TIME4] NE 0.), icnt1000)
...
FOR TIME4 = 0,nmbr DO BEGIN
	...
	INDEX1000 = WHERE((CAPE_EVENT_NEW[*,TIME4] NE 0.) AND (CAPE_EVENT_NEW[*,TIME4] LT 10000.) AND (dCAPElse_EVENT_NEW[*,TIME4] GT -50000.) AND (dCAPElse_EVENT_NEW[*,TIME4] LT 50000.) AND (dCAPElse_EVENT_NEW[*,TIME4] NE 0.) AND (dCAPElsp_EVENT_NEW[*,TIME4] GT -50000.) AND (dCAPElsp_EVENT_NEW[*,TIME4] LT 50000.) AND (dCAPElsp_EVENT_NEW[*,TIME4] NE 0.), icnt1000) 
...
rpsopen, 'all_forcing_initiate_TWP_spCAM1997_time_rCAPE_1mm_rain_1E-4.eps', /encap, xs=10, ys=30, /inches, /color
