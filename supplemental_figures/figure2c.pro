...
FOR l0=1,nlon0-2 DO BEGIN
 FOR l1=1,nlat0-2 DO BEGIN
  FOR l2=1,12239 DO BEGIN
   ...
   PCAPE    [counter0] = PCAPE0  [l0,l1,l2,0]; + PCAPE0[l0,l1,l2,2]
...
;===================================================================================
rpsopen, '2D_pdf_reversible_dCAPElse_vs_CAPE_spCAM5_h2_pcp_e-4_small_binsize_tp', /encap, xs=14, ys=10, /inches, /color
